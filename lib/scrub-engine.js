...
function injectCSS() {
  ...
  .sw-brand__logo{height:clamp(30px,4.2vw,42px);width:auto;display:block;filter:drop-shadow(0 1px 2px rgba(255,255,255,.7)) drop-shadow(0 0 6px rgba(255,255,255,.35));}
